    ...
    <>
      ...
      <div className="Seats">
        {SeatList.map((seat, ind) => (
          <button className={RepresentSeatColor(seat.isAvailable, Selected)}>
      ...
      <div className="CustomerForm">
        <form onSubmit={submitData}>
          ...
          <input type="text" id="nome" placeholder="Digite seu nome"></input>
          <label htmlFor="cpf">CPF do comprador:</label>
          <input type="number" id="cpf" placeholder="Digite seu nome"></input>
